...
const allServiceAreas = (storeInfo.branches || []).flatMap(b => b.serviceArea || [])
    ...
    <section id="keunggulan" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-stone-900 mb-4">Keunggulan Kami</h2>
        ...
        <div className="bg-gradient-to-r from-amber-800 to-amber-900 rounded-3xl p-8 md:p-10 text-white roof-texture">
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
            <div className="flex-1">
              ...
              <p className="text-amber-200 text-sm mb-4">Pengiriman & konsultasi langsung ke lokasi Anda</p>
