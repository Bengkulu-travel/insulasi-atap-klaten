        ...
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="font-display font-bold text-white">Insulasi Atap</div>
                <div className="text-amber-400 text-xs tracking-wider">KLATEN & YOGYAKARTA</div>
              </div>
            </div>
            <p className="text-stone-400 text-sm leading-relaxed mb-4">
              Toko insulasi atap terpercaya di Klaten dan Yogyakarta. Menyediakan berbagai produk insulasi berkualitas untuk kenyamanan rumah Anda.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[['#produk','Produk'],['#keunggulan','Keunggulan'],['#galeri','Galeri'],['#lokasi','Lokasi'],['/ ','Klaten'],['/jogja','Yogyakarta']].map(([href, label]) => (
                <li key={href}>
                  <a href={href.trim()} className="text-stone-400 hover:text-amber-400 text-sm transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex gap-2 text-stone-400">
                <span>📍</span><span>Klaten & Yogyakarta</span>
              </div>
              <div className="flex gap-2 text-stone-400">
                <span>🕐</span><span>{storeInfo.openHours}</span>
              </div>
              <div className="flex gap-2 text-stone-400">
                <span>🚚</span><span>Pengiriman: Klaten, Jogja & sekitarnya</span>
              </div>
            </div>
          </div>
        </div>
