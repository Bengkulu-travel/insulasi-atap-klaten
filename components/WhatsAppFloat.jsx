...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold px-4 py-3 rounded-full shadow-xl shadow-green-500/40 transition-all group-hover:shadow-green-500/60 group-hover:scale-105">
