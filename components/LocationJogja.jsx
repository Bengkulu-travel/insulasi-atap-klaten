      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="rounded-3xl overflow-hidden shadow-lg border border-stone-100 h-80">
            <iframe
              src="https://maps.google.com/maps?q=Yogyakarta,+DIY&output=embed&z=14"
              width="100%"
              height="100%"
          ...
          <div className="space-y-4">
            <div className="p-5 bg-amber-50 rounded-2xl border border-amber-100 flex gap-4">
              ...
              <div>
                ...
                <div className="text-stone-600 text-sm">{branch.address || 'Yogyakarta, DIY'}</div>
            ...
            <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100 flex items-center justify-between">
              ...
              <a href="/#lokasi" className="text-amber-700 text-sm font-bold hover:underline flex items-center gap-1 flex-shrink-0">
                Lihat Lokasi →
              </a>
            </div>

            <a href={waUrl} target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 rounded-2xl transition-all hover:shadow-xl hover:shadow-green-500/30">
