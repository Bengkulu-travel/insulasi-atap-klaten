  ...
  return (
    <article>
      ...
      <div className="space-y-6 text-stone-700 leading-relaxed">
        ...
        <p className="mt-6">Masih ada pertanyaan? <a href="https://wa.me/6208131556592?text=Halo, saya lihat di insulasiatap.biz.id, saya punya pertanyaan tentang insulasi atap." target="_blank" rel="noopener noreferrer" className="text-amber-700 hover:underline font-medium">Tanya langsung via WhatsApp</a> - tim kami siap membantu.</p>
